...
function th_shop_mania_widgets_init(){
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Main Header Widget', 'th-shop-mania' ),
		'id'            => 'main-header-widget',
		'description'   => esc_html__( 'Add widgets here to appear in main header.', 'th-shop-mania' ),
    ...
    register_sidebar(array(
		'name'          => esc_html__( 'Footer Top First Widget', 'th-shop-mania' ),
		'id'            => 'footer-top-first',
		'description'   => esc_html__( 'Add widgets here to appear in top footer.', 'th-shop-mania' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h2 class="widget-title">',
		'after_title'   => '</h2>',
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer Top Second Widget', 'th-shop-mania' ),
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer Top Third Widget', 'th-shop-mania' ),
		'id'            => 'footer-top-third',
		'description'   => esc_html__( 'Add widgets here to appear in top footer.', 'th-shop-mania' ),
		'before_widget' => '<div id="%1$s" class="widget %2$s">',
		'after_widget'  => '</div>',
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer Below First Widget', 'th-shop-mania' ),
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer Below Second Widget', 'th-shop-mania' ),
	...
	register_sidebar(array(
		'name'          => esc_html__( 'Footer Below Third Widget', 'th-shop-mania' ),
