  ...
  if ( !get_user_meta( $user_id, esc_html( $theme_data->get( 'TextDomain' ) ) . '_notice_ignore' ) ) {
    ...
    <div class="notice thunk-notice">
      ...
      <h1>
        ...
        printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'th-shop-mania' ), apply_filters( 'zita_page_title', __( 'Th Shop Mania', 'th-shop-mania' ) ), esc_html( $theme_data->Version ) );
        ?>
      </h1>
      <p>
        <?php
        /* translators: %1$s: theme name, %2$s link */
        printf( __( 'Welcome! Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our <a href="%2$s">Welcome page</a>', 'th-shop-mania' ), apply_filters( 'zita_page_title', __( 'Th Shop Mania', 'th-shop-mania' ) ), esc_url( admin_url( 'themes.php?page=th_shop_mania_thunk_started' ) ) );
      ...
      <p>
        <a href="<?php echo esc_url( admin_url( 'themes.php?page=th_shop_mania_thunk_started' ) ) ?>" class="button button-primary button-hero" style="text-decoration: none;">
          ...
          printf( esc_html__( 'Get started with %s', 'th-shop-mania' ), apply_filters( 'zita_page_title', __( 'Th Shop Mania', 'th-shop-mania' ) ) )
          ?>
        </a>
