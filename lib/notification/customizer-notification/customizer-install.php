...
function th_shop_mania_customize_install_register($wp_customize) {
    ...
    include_once get_template_directory() . '/lib/notification/customizer-notification/thsm-custom-section.php';
...
function th_shop_mania_customizer_scripts() {
    ...
    wp_enqueue_script('th-shop-mania-customizer-notice', get_template_directory_uri() . '/lib/notification/customizer-notification/customizer.js', array('customize-controls'));
}
