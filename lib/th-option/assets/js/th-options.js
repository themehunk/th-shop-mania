...
(function($){
    ...
    THoptionAdmin = {
        init: function(){
            // In update this condition will change by typeof mania_companion_import && typeof th_shop_mania_import basis
            // if (typeof hunk_companion_import !== 'undefined') {
            //     __plugin = 'hunk-companion';
            // }   
            // else{
            //     __plugin = 'mania-companion';
            // }
            // this.rPlugins = [__plugin];

            this.rPlugins = ['hunk-companion','th-shop-mania-pro'];
        ...
        _onClickBtn:function(){
            ...
            $('.th-license-tab-button, .th-whitelabel-tab-button').on('click', function() {
                $('.tablinks').css('color', '#111');
                $(this).css('color', '#228add');
            });
        },
      ...
      _pluginexists: function(slug) {
        ...
        _bind: function(){               
            ...
            // This is for custom button starter sites in Import Demo TAB
            $('.appearance_page_th_shop_mania_thunk_started #Import-Demo-Content .import-demo .theme_link button.activate-now').html('Starter site plugin');
            $('.appearance_page_th_shop_mania_thunk_started #Import-Demo-Content .import-demo .theme_link button.disabled').html('Starter Site Activated');
        },
