...
<div class="th-option-area">
        ...
        <div class="th-option-bottom-hdr">
            <a class="tablinks active" onclick="openTab(event, 'Welcome')"><?php _e('Welcome','th-shop-mania');?></a>
            <a class="tablinks" onclick="openTab(event, 'Recommended-Plugin')"><?php _e('Recommended Plugin','th-shop-mania');?> </a>
            <a class="tablinks th-import-tab-button" onclick="openTab(event, 'Import-Demo-Content')"><?php _e('Demo Import','th-shop-mania');?> <p class="tooltiptext"><?php _e('Starter Templates','th-shop-mania');?></p> </a>
            <a class="tablinks get-child" onclick="openTab(event, 'Get-Child-Theme')"><?php _e('Get Child Theme','th-shop-mania');?></a>
            <a class="tablinks" onclick="openTab(event, 'Free-Vs-Pro')"><?php _e('Free Vs Pro','th-shop-mania');?></a>
            <a class="tablinks" onclick="openTab(event, 'Help')"><?php _e('Help','th-shop-mania');?></a>
