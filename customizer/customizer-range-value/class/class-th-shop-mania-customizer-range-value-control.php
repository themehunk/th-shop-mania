 ...
 * @access public
 */
class Th_Shop_Mania_WP_Customizer_Range_Value_Control extends WP_Customize_Control {
 ...
 * @since 1.1.38
 */
function th_shop_mania_sanitize_range_value( $input ){
	if ( th_shop_mania_is_json( $input ) ) {
