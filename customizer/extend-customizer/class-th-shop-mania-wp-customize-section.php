...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 */
	class  Th_Shop_Mania_WP_Customize_Section extends WP_Customize_Section {
		...
		public function json() {
			...
			if ( $this->panel ) {
				$array['customizeAction'] = sprintf(__('Customizing &#9656; %s','th-shop-mania'), esc_html( $this->manager->get_panel( $this->panel )->title ) );
			} else {
				$array['customizeAction'] = __('Customizing','th-shop-mania');
			}
