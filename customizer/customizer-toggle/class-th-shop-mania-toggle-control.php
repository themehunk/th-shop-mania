 ...
 * @access public
 */
class th_shop_mania_Toggle_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_style( 'th-shop-mania-toggle-control-styles', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.css' ), false, '1.0.0', 'all' );
		wp_enqueue_script( 'th-shop-mania-toggle-control-scripts', get_parent_theme_file_uri( 'customizer/customizer-toggle/toggle.js' ), array( 'jquery' ), '1.0.0', true );
	}
	/**
