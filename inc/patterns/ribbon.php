...
<h2 class="has-text-align-center has-white-color has-text-color has-large-font-size" style="font-style:normal;font-weight:600">'.esc_html__('“Pleasure in the job puts perfection in the work”','th-shop-mania').'</h2>
<!-- /wp:heading -->
...
<div class="wp-block-button has-custom-font-size is-style-fill has-normal-font-size"><a class="wp-block-button__link has-white-background-color has-text-color has-background wp-element-button" style="border-radius:4px;color:#4167cf;padding-top:1rem;padding-right:2rem;padding-bottom:1rem;padding-left:2rem">'.esc_html__('Explore it','th-shop-mania').'</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->',
);