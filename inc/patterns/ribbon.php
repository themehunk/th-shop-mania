...
<div class="wp-block-button has-custom-font-size is-style-fill has-normal-font-size"><a class="wp-block-button__link has-white-background-color has-text-color has-background wp-element-button" style="border-radius:4px;color:#4167cf;padding-top:1rem;padding-right:2rem;padding-bottom:1rem;padding-left:2rem">Explore it</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->',
);