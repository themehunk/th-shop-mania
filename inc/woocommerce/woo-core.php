	...
	class Th_Shop_Mania_Pro_Woocommerce_Ext{
       ...
       /**
		...
		function th_shop_mania_add_scripts(){
		   wp_enqueue_script( 'th-shop-mania-woocommerce-js', TH_SHOP_MANIA_THEME_URI .'/inc/woocommerce/js/woocommerce.js', array( 'jquery','th-sale-countdownfront-js' ), '2.0.0', true );
