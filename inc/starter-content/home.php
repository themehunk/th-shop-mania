...
<div class="wp-block-group alignwide" id="collections"><!-- wp:columns {"align":"full","style":{"spacing":{"blockGap":{"top":"12px","left":"12px"}}}} -->
<div class="wp-block-columns alignfull"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:columns {"isStackedOnMobile":false,"style":{"spacing":{"blockGap":{"top":"12px","left":"12px"}}}} -->
...
<div class="wp-block-cover is-light" style="min-height:210px"><img class="wp-block-cover__image-background wp-image-865" alt="" src="' . esc_url( TH_SHOP_MANIA_THEME_URI . 'inc/starter-content/images/').'image1.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"typography":{"fontStyle":"normal","fontWeight":"600","lineHeight":1.6},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"textColor":"background","fontSize":"content-heading"} -->
...
<div class="wp-block-cover is-light" style="min-height:210px"><img class="wp-block-cover__image-background wp-image-872" alt="" src="' . esc_url( TH_SHOP_MANIA_THEME_URI . 'inc/starter-content/images/').'image2.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"background","fontSize":"content-heading"} -->
...
<div class="wp-block-cover is-light" style="min-height:210px"><img class="wp-block-cover__image-background wp-image-875" alt="" src="' . esc_url( TH_SHOP_MANIA_THEME_URI . 'inc/starter-content/images/').'image3.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"textColor":"background","fontSize":"content-heading"} -->
...
<div class="wp-block-cover" style="min-height:210px"><img class="wp-block-cover__image-background wp-image-882" alt="" src="' . esc_url( TH_SHOP_MANIA_THEME_URI . 'inc/starter-content/images/').'image4.jpg" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","style":{"elements":{"link":{"color":{"text":"var:preset|color|foreground"}}}},"fontSize":"content-heading"} -->
...
<div class="wp-block-cover alignfull" style="padding-top:var(--wp--preset--spacing--30);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30);padding-left:var(--wp--preset--spacing--30)"><img class="wp-block-cover__image-background wp-image-902" alt="" src="' . esc_url( TH_SHOP_MANIA_THEME_URI . 'inc/starter-content/images/').'ribbon.jpg" style="object-position:49% 22%" data-object-fit="cover" data-object-position="49% 22%"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-10 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","textColor":"foreground","fontSize":"upper-heading"} -->
...
<div class="wp-block-buttons"><!-- wp:button {"className":"aligncenter","style":{"border":{"radius":"5px"},"color":{"background":"#0029ff"}},"fontSize":"small"} -->
<div class="wp-block-button aligncenter"><a class="wp-block-button__link has-background has-small-font-size has-custom-font-size wp-element-button" style="border-radius:5px;background-color:#0029ff">SHOP NOW</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover --></div>
<!-- /wp:group -->
...
<div class="wp-block-group alignfull has-white-background-color has-background" id="offers" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|30"}},"typography":{"lineHeight":1.6}},"textColor":"black","fontSize":"x-large"} -->
<h2 class="wp-block-heading has-text-align-center has-black-color has-text-color has-x-large-font-size" style="margin-bottom:var(--wp--preset--spacing--30);line-height:1.6">Great offers on new launched products</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","style":{"color":{"text":"#828282"}},"fontSize":"extra-small"} -->
<p class="has-text-align-center has-text-color has-extra-small-font-size" style="color:#828282">Cras enim neque, viverra vitae facilisis quis, interdum ut justo</p>
<!-- /wp:paragraph -->
...
<!-- wp:group {"align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|30","bottom":"var:preset|spacing|70","left":"var:preset|spacing|30"}},"color":{"background":"#f4f5f6"}},"layout":{"type":"default"}} -->
<div class="wp-block-group alignwide has-background" id="shop" style="background-color:#f4f5f6;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--30)"><!-- wp:group {"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
<div class="wp-block-group"><!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}}} -->
<h2 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--60)">* 1 Year Warranty</h2>
<!-- /wp:heading -->

<!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}}} -->
<h2 class="wp-block-heading" style="margin-bottom:var(--wp--preset--spacing--60)">* 14 Days Easy Replacements</h2>
<!-- /wp:heading -->

<!-- wp:heading -->
<h2 class="wp-block-heading">* Best exchange offers</h2>
<!-- /wp:heading --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:heading {"textAlign":"center","style":{"typography":{"lineHeight":"1.2"},"spacing":{"margin":{"bottom":"var:preset|spacing|40"}}},"textColor":"black","fontSize":"large"} -->
<h2 class="wp-block-heading has-text-align-center has-black-color has-text-color has-large-font-size" style="margin-bottom:var(--wp--preset--spacing--40);line-height:1.2">I absolutely love this</h2>
<!-- /wp:heading -->
...
<!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"1.9"}}} -->
<p class="has-text-align-center" style="line-height:1.9">Suspendisse dignissim ante sed nunc sollicitudin tristique. Nullam nec Suspendisse dignissim ante sed nunc sollicitudin tristique. Nullam nec felis mollis, gravida nibh at, porta antefelis mollis, gravida nibh at, porta ante</p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center" style="line-height:1"><em>Alexandra Black</em></p>
<!-- /wp:paragraph -->
...
<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"center"}} -->
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-fill","style":{"color":{"background":"#0029ff"},"border":{"radius":"4px"}}} -->
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link has-background wp-element-button" style="border-radius:4px;background-color:#0029ff">Launch Store</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->';
...
return array(
	'post_type'    => 'page',
	'post_title'   => _x( 'Home', 'Theme starter content', 'th-shop-mania' ),
	'post_content' => $th_shop_mania_starter_content,
);
