...
<!-- wp:heading {"style":{"typography":{"lineHeight":"1.2"},"spacing":{"margin":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"textColor":"black","fontSize":"huge"} -->
<h2 class="wp-block-heading has-black-color has-text-color has-huge-font-size" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--50);line-height:1.2">Stylish &amp; Modern Furniture</h2>
<!-- /wp:heading -->
...
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"5px"},"color":{"background":"#0029ff"}},"className":"aligncenter","fontSize":"small"} -->
<div class="wp-block-button has-custom-font-size aligncenter has-small-font-size"><a class="wp-block-button__link has-background wp-element-button" style="border-radius:5px;background-color:#0029ff">SHOP NOW</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<p class="has-text-color has-extra-small-font-size" style="color:#828282">Cras enim neque, viverra vitae facilisis quis, interdum ut justo</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<div class="wp-block-buttons"><!-- wp:button {"textColor":"white","style":{"border":{"radius":"5px"},"color":{"background":"#0029ff"}}} -->
<div class="wp-block-button"><a class="wp-block-button__link has-white-color has-text-color has-background wp-element-button" style="border-radius:5px;background-color:#0029ff">ORDER NOW</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<!-- wp:heading {"style":{"typography":{"lineHeight":"1.7"}},"textColor":"black","fontSize":"large"} -->
<h2 class="wp-block-heading has-black-color has-text-color has-large-font-size" style="line-height:1.7">Wooden Soft Chair -Sheesham</h2>
<!-- /wp:heading -->
...
<p class="has-extra-large-font-size">$99 </p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"normal"} -->
<p class="has-normal-font-size"><s>$189 </s></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:buttons {"layout":{"type":"flex","justifyContent":"left"}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"border":{"radius":"5px"},"color":{"background":"#0029ff"}},"className":"aligncenter","fontSize":"small"} -->
<div class="wp-block-button has-custom-font-size aligncenter has-small-font-size"><a class="wp-block-button__link has-background wp-element-button" href="#" style="border-radius:5px;background-color:#0029ff">Add To Cart</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
...
<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|60"}}}} -->
